...
export default function Message() {
  return (
    <div className='absolute flex right-0 bg-red-500 w-full lg:w-auto min-h-screen top-0'>
      ...
      <div className=' flex sticky lg:fixed mt-96 pt-5 w-20 lg:w-80 ml-8 h-16'>
      ...
      <div className='max-h-screen p-5 overflow-auto scrollbar-hidden'>
        <p className='w-auto'>
          <a className=' hover:cursor-pointer block rounded-full my-5 font-bold bg-opacity-60 w-10 h-10 lg:w-16 lg:h-16 bg-white'>
            <img src='#' alt='loading' />
          </a>
          <a className=' hover:cursor-pointer block rounded-full my-5 font-bold bg-opacity-60 w-10 h-10 lg:w-16 lg:h-16 bg-white'>
            <img src='#' alt='loading' />
